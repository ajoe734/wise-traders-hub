...
COMMENT ON FUNCTION public.get_expert_capital_status(uuid) IS 'Returns expert capital status with open position quantity_unit/currency/derived asset_class so journal editor never treats actual shares as lots.';
