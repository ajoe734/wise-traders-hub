...
BEGIN
  ...
  INSERT INTO public.tw_bsr_sync_config(key, config, note, updated_at, version)
  VALUES ('degrade:' || _api, _cfg, 'auto-degrade', _now, 1)
  ON CONFLICT (key) DO UPDATE
    SET config = EXCLUDED.config,
        updated_at = _now,
        note = 'auto-degrade',
        version = public.tw_bsr_sync_config.version + 1;
