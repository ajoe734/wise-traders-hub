-- P0_UNPUBLISHED_JOURNAL_EDIT_ISOLATION_V1 (migration artifact; byte-identical body to db/p0-journal-edit-isolation/update_pending_mentor_journal_batch.sql)
