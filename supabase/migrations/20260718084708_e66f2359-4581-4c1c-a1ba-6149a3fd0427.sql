...
BEGIN
  ...
  -- Compute Monday 00:00 and Friday 23:59:59 of the signal's publish week (UTC based on published_at)
...
GRANT EXECUTE ON FUNCTION public.get_owned_journal_bundle(uuid) TO authenticated;
