#!/usr/bin/env python3
"""R0-B: read-only catalog extraction of the economic object subset into replayable DDL.
No pg_dump, no data. Emits db/r0/clone/schema.sql"""
...
open('db/r0/clone/schema.sql','w').write('\n'.join(out)+'\n')
print('wrote db/r0/clone/schema.sql', len(out), 'statements-ish')
