...
export const MobileVsCarousel = () => {
  ...
  const handleSwipe = (e: React.TouchEvent) => {
    ...
    if (Math.abs(diff) > 50) {
      if (diff > 0 && selectedIndex > 0) setSelectedIndex(0);
      else if (diff < 0 && selectedIndex < 1) setSelectedIndex(1);
    }
  };
            ...
            >
              ...
              >
                <div
                  ...
                  style={{ minHeight: '380px', backgroundColor: '#1a1a1a' }}
                >
                  <div
                  ...
                  >
                    <div className="w-12 h-1 mb-3 rounded-full" style={{ background: card.accentBar }} />
                    <p
        ...
        {cards.map((card, index) => (
          <button
            ...
            className={`h-2 rounded-full transition-all duration-300 ${
              index === selectedIndex ? `${card.accentColor} w-8` : 'bg-black/30 dark:bg-white/30 w-2'
            }`}
          />
        ))}
      </div>
...
export const MobilePreviewCarousel = () => {
  const [selectedIndex, setSelectedIndex] = useState(0);
  ...
  return (
    <div className="md:hidden relative">
      <div className="relative overflow-hidden" onTouchStart={handleTouchStart} onTouchEnd={handleSwipe}>
        <div
...
export default { MobileVsCarousel, MobilePreviewCarousel };
