      ...
      <CardContent className="p-4 grid grid-cols-2 md:grid-cols-4 gap-3">
        <div>
          ...
          <div className="text-base font-semibold tabular-nums">
            ...
            {isUsd && <FxHint amount={capital.starting_capital || 0} currency={currency} showMeta={false} />}
          </div>
        </div>
        <div>
          ...
          <div className={cn('text-lg font-bold tabular-nums', capital.available_cash < 0 ? 'text-destructive' : '')}>
            ...
            {isUsd && <FxHint amount={capital.available_cash || 0} currency={currency} showMeta={false} />}
          </div>
        </div>
        <div>
          ...
          <div className="text-base font-semibold tabular-nums">
            ...
            {isUsd && <FxHint amount={capital.open_cost_value || 0} currency={currency} showMeta={false} />}
          </div>
        </div>
        <div>
          ...
          <div className={cn('text-base font-semibold tabular-nums', pnlColor(capital.realized_pnl_amount))}>
            ...
            {isUsd && <FxHint amount={capital.realized_pnl_amount || 0} currency={currency} showMeta={false} />}
          </div>
        </div>
      </CardContent>
    </Card>
