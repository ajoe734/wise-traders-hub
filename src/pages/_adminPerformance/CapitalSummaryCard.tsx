    ...
    <Card>
      <CardContent className="p-4 grid grid-cols-2 md:grid-cols-4 gap-3">
        <div>
          ...
          <div className="text-base font-semibold tabular-nums">{fmtMoney(capital.starting_capital || 0, currency)}</div>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="text-base font-semibold tabular-nums">{fmtMoney(capital.open_cost_value || 0, currency)}</div>
        </div>
        <div>
