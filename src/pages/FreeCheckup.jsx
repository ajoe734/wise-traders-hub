...
const lbl   = { fontSize:11, color:C.textMute, letterSpacing:"0.13em", textTransform:"uppercase", fontWeight:700, marginBottom:7 };
    ...
    <div style={{background:C.bg,minHeight:"100vh",color:C.text,
      ...
      <div style={{background:C.card,borderBottom:`1px solid ${C.border}`,
        ...
        <div style={{display:"flex",justifyContent:"space-between",marginBottom:12}}>
          <div>
            <div style={{fontSize:11,color:C.textMute,letterSpacing:"0.15em",textTransform:"uppercase",fontWeight:500}}>
          ...
          <div style={{textAlign:"right"}}>
            <div style={{fontSize:11,color:C.textMute,marginBottom:2}}>未實現損益</div>
                  ...
                  {editing && (()=>{
                    ...
                    return <div style={{marginTop:8,background:C.subtle,borderRadius:7,padding:10}}>
                      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6,marginBottom:6}}>
                        <div>
                          <div style={{fontSize:11,color:C.textMute,marginBottom:2}}>反轉目標價</div>
                        ...
                        <div>
                          <div style={{fontSize:11,color:C.textMute,marginBottom:2}}>停損價</div>
                      ...
                      <div style={{marginBottom:6}}>
                        <div style={{fontSize:11,color:C.textMute,marginBottom:2}}>反轉訊號（什麼條件出現代表反轉？）</div>
                      ...
                      <div style={{marginBottom:8}}>
                        <div style={{fontSize:11,color:C.textMute,marginBottom:2}}>備註</div>
          ...
          <div style={card}>
            {displayed.map((h,i)=>{
              ...
              <div key={h.code} style={{
                ...
                <div style={{display:"flex",alignItems:"center",gap:6,flexWrap:"wrap",marginBottom:4}}>
                  <span style={{fontSize:17,fontWeight:600,color:C.text}}>{h.name}</span>
                  <span style={{fontSize:12,color:C.textMute}}>{h.code}</span>
                  {h.type!=="股票"&&(
                  ...
                  {h.expire&&<span style={{fontSize:12,color:C.amber,fontWeight:500}}>到期{h.expire}</span>}
                  {h.alert&&<span style={{fontSize:12,color:C.up,fontWeight:600}}>{h.alert}</span>}
                  {isNew&&<span style={{fontSize:12,padding:"1px 6px",borderRadius:3,
                ...
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"baseline"}}>
                  <div style={{fontSize:14,color:C.textMute}}>
                  ...
                  <div style={{display:"flex",gap:10,alignItems:"baseline",flexShrink:0,paddingLeft:8}}>
                    <span style={{fontSize:14,color:C.textMute}}>損益</span>
                    <span style={{fontSize:15,fontWeight:600,color:pc(h.pnl)}}>{h.pnl>=0?"+":""}{h.pnl?.toLocaleString()}</span>
                    <span style={{fontSize:14,color:C.textMute}}>報酬</span>
                    <span style={{fontSize:14,fontWeight:600,color:pc(h.pct)}}>{h.pct>=0?"+":""}{h.pct?.toFixed(2)}%</span>
                  </div>
                </div>
                {/* 目標價進度條 */}
                {tp && (
            ...
            {!showAll && sorted.length>12 && (
              <button onClick={()=>setShowAll(true)} style={{
                ...
                borderRadius:8,color:C.textMute,fontSize:13,cursor:"pointer",fontWeight:400,
                  ...
                  return <div key={i} style={{...card,marginBottom:7,
                    ...
                    <div style={{display:"flex",gap:10,alignItems:"flex-start"}}>
                      <div style={{minWidth:48}}>
                        ...
                        <div style={{fontSize:11,color:C.textMute,textAlign:"center",lineHeight:1.4}}>{e.date}</div>
                      </div>
                      <div style={{flex:1}}>
                        ...
                        {e.pred && (
                          <div style={{display:"flex",alignItems:"center",gap:4,marginTop:4}}>
                            ...
                            {e.predReason && <span style={{fontSize:11,color:C.textMute,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",maxWidth:140}}>{e.predReason}</span>}
                          </div>
                        )}
                      </div>
                      <button onClick={()=>{
                        ...
                        borderRadius:6,padding:"3px 8px",fontSize:11,fontWeight:500,cursor:"pointer",
            ...
            <div id="daily-report-top" style={{...card,marginBottom:10,
              ...
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                <div>
                  ...
                  <div style={{fontSize:11,color:C.textMute}}>{dailyReport.time} 更新</div>
                </div>
                <div style={{textAlign:"right"}}>
                  <div style={{fontSize:11,color:C.textMute}}>今日損益</div>
              ...
              {dailyReport.changes.map((c,i)=>(
                <div key={c.code} style={{display:"flex",justifyContent:"space-between",alignItems:"center",
                  ...
                  <div>
                    ...
                    <span style={{fontSize:11,color:C.textMute,marginLeft:5}}>{c.code}</span>
                    {c.type!=="股票"&&<span style={{fontSize:11,marginLeft:5,padding:"1px 5px",borderRadius:3,
              ...
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:10}}>
                ...
                <div style={{display:"flex",gap:6}}>
                  <button onClick={()=>{
                    ...
                    a.click();
                  }} style={{fontSize:11,padding:"3px 8px",borderRadius:4,border:`1px solid ${C.border}`,background:"transparent",color:C.textMute,cursor:"pointer"}}>
                    匯出
                  </button>
                  <button onClick={()=>{
                  ...
                  }} style={{fontSize:11,padding:"3px 8px",borderRadius:4,border:`1px solid ${C.up}44`,background:"transparent",color:C.up,cursor:"pointer"}}>
                    重置
                  </button>
                </div>
              </div>
              <div style={{fontSize:11,color:cloudSync?C.olive:C.textMute,marginTop:6}}>
            ...
            return (
              <div style={{...card}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                  ...
                  <span style={{fontSize:11,color:C.textMute}}>共 {validHistory.length} 筆</span>
                </div>
                    ...
                    {isExpanded && (
                      <div style={{padding:"10px 4px",borderBottom:`1px solid ${C.border}`,marginBottom:4}}>
                        ...
                        {r.changes && r.changes.length > 0 && (
                          <div style={{marginBottom:8}}>
                            <div style={{fontSize:11,color:C.textMute,fontWeight:600,marginBottom:4,letterSpacing:"0.06em"}}>持倉漲跌</div>
                            ...
                            {r.changes.length>5 && <div style={{fontSize:11,color:C.textMute,marginTop:2}}>...還有 {r.changes.length-5} 檔</div>}
                          </div>
                        )}
                        {/* 自動驗證 */}
                        {(r.autoVerified||[]).length>0 && (
                          <div style={{marginBottom:8,background:C.oliveBg,borderRadius:6,padding:"6px 8px"}}>
                            <div style={{fontSize:11,color:C.olive,fontWeight:600,marginBottom:3}}>自動驗證 {r.autoVerified.length} 件</div>
            ...
            <>
              <div
                ...
                {img ? (
                  ...
                  <div style={{fontSize:13,color:C.textMute,marginTop:4}}>買進 · 賣出回報皆可</div></>
                )}
              </div>
              {img && (
              ...
              <div style={{...card,marginBottom:12}}>
                ...
                {parsed.targetPriceUpdates?.length>0 && (
                  <div style={{marginTop:10,background:C.tealBg,border:`1px solid ${C.teal}44`,
                    ...
                    <div style={{fontSize:11,color:C.teal,fontWeight:600,marginBottom:4}}>
                      偵測到目標價更新
                    </div>
            ...
            return (
              <div style={{...card,marginTop:14,borderLeft:`2px solid ${C.teal}66`}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:7,marginBottom:7}}>
                  <div>
                    <div style={{fontSize:11,color:C.textMute,marginBottom:3}}>股票代碼</div>
                  ...
                  <div>
                    <div style={{fontSize:11,color:C.textMute,marginBottom:3}}>目標價（元）</div>
                ...
                <div style={{marginBottom:10}}>
                  <div style={{fontSize:11,color:C.textMute,marginBottom:3}}>券商 / 來源</div>
                ...
                <div style={{display:"flex",alignItems:"center",gap:8,padding:"10px 12px"}}>
                  ...
                  <div style={{flex:1, minWidth:0}}>
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:6,marginTop:3,flexWrap:"wrap"}}>
                      <span style={{fontSize:11,color:C.textMute}}>{e.date}</span>
                      {e.stocks.slice(0,2).map((s,si)=>{
                        const label = typeof s === "string" ? s.split(" ")[0] : (s.code || s.name || "");
                        return <span key={si} style={{fontSize:11,padding:"1px 6px",borderRadius:3,
                          background:C.subtle,color:C.textSec}}>{label}</span>;
                      })}
                      {e.stocks.length>2 && <span style={{fontSize:11,color:C.textMute}}>+{e.stocks.length-2}</span>}
                    </div>
                  </div>
                  ...
                  <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:3,flexShrink:0}}>
                    ...
                    {e.status==="pending" && (
                      <span style={{fontSize:11,color:C.textMute,fontWeight:500}}>待驗證</span>
                    )}
                  ...
                  <div style={{
                    ...
                    <div style={{display:"flex",gap:5,flexWrap:"wrap",marginBottom:10}}>
                      {e.stocks.map((s,si)=>{
                        ...
                        return <span key={si} style={{fontSize:11,padding:"2px 8px",borderRadius:3,
                    ...
                    <div style={{background:C.subtle,borderRadius:7,padding:"9px 11px",marginBottom: e.actualNote?8:0}}>
                      <div style={{fontSize:11,color:predC(e.pred),fontWeight:600,marginBottom:3,letterSpacing:"0.05em"}}>
                    ...
                    {e.actualNote && (
                      <div style={{
                        ...
                        <div style={{fontSize:11,color: isCorrect?C.olive:C.up,fontWeight:600,marginBottom:3,letterSpacing:"0.05em"}}>
                    ...
                    {e.lessons && (
                      <div style={{background:C.blueBg,border:`1px solid ${C.blue}33`,
                        borderRadius:7,padding:"9px 11px",marginTop:8}}>
                        <div style={{fontSize:11,color:C.blue,fontWeight:600,marginBottom:3}}>策略覆盤教訓</div>
                    ...
                    {reviewingEvent===e.id && (
                      <div onClick={ev=>ev.stopPropagation()}
                        ...
                        <div style={{marginBottom:10}}>
                          <div style={{fontSize:11,color:C.textMute,marginBottom:4}}>實際走勢</div>
                          <div style={{display:"flex",gap:6}}>
                        ...
                        <div style={{marginBottom:10}}>
                          <div style={{fontSize:11,color:C.textMute,marginBottom:4}}>發生了什麼？股價怎麼走？</div>
                        ...
                        <div style={{marginBottom:10}}>
                          <div style={{fontSize:11,color:C.textMute,marginBottom:4}}>策略覆盤：問題出在哪？學到什麼？下次怎麼改？</div>
          ...
          return <>
            ...
            <div style={{
              ...
              {[
                ...
                <div key={l} style={{background:bg,border:`1px solid ${C.border}`,borderRadius:10,padding:"10px 11px"}}>
                  <div style={{fontSize:11,color:C.textMute,letterSpacing:"0.06em"}}>{l}</div>
            ...
            {showAddEvent && (
              <div style={{...card,marginBottom:12,borderLeft:`2px solid ${C.blue}88`}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:7,marginBottom:7}}>
                  <div>
                    <div style={{fontSize:11,color:C.textMute,marginBottom:3}}>日期</div>
                  ...
                  <div>
                    <div style={{fontSize:11,color:C.textMute,marginBottom:3}}>相關個股（逗號分隔）</div>
                ...
                <div style={{marginBottom:7}}>
                  <div style={{fontSize:11,color:C.textMute,marginBottom:3}}>事件標題</div>
                ...
                <div style={{marginBottom:7}}>
                  <div style={{fontSize:11,color:C.textMute,marginBottom:3}}>事件細節</div>
                ...
                <div style={{marginBottom:7}}>
                  <div style={{fontSize:11,color:C.textMute,marginBottom:4}}>預測方向</div>
                  <div style={{display:"flex",gap:6}}>
                    {["up","down","neutral"].map(v=>(
                ...
                <div style={{marginBottom:10}}>
                  <div style={{fontSize:11,color:C.textMute,marginBottom:3}}>預測邏輯</div>
            ...
            <div style={{
              ...
              <span style={{fontSize:11,color:C.textMute}}>點擊展開詳情</span>
            </div>
            {(()=>{
              const LIMIT = 10;
