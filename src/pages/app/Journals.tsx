  ...
  return (
    <AppLayout>
      <div className="p-4 space-y-4">
        ...
        <p className="text-sm text-muted-foreground mb-4">來自您訂閱的實戰導師的 T+7 週記</p>
        ...
        {journals.length > 0 ? (
          ...
          <Card><CardContent className="p-6 text-center text-muted-foreground">目前尚未訂閱任何實戰導師</CardContent></Card>
        )}
      </div>
    </AppLayout>
  );
