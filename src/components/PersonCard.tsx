      ...
      <CardContent className="p-0">
        <div className="p-5">
          <div className="flex items-start gap-4">
            <img src={avatarUrl(person.avatarUrl, 112)} alt={person.name} loading="lazy" decoding="async" className="shrink-0 h-14 w-14 rounded-full object-cover object-[center_15%] ring-2 ring-muted" />
