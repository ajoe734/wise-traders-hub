...
import {
  ...
  LogOut, Moon, Sun, Building2, Megaphone, FileClock, Receipt, Settings, Layers, Activity, Brain, Gauge, AlertTriangle, ScrollText, History, Shield, Menu, FlaskConical, Bell, TrendingUp, FileText, Coins
} from 'lucide-react';
